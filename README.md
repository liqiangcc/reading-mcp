...
部署前阅读 [启用及回滚说明](docs/pdf-layout-deployment.md) 和 [Issue #89 评审结果](docs/issue89-review.md)。本版本使用 normalization v9、segmentation v3，需要重新打开文档并获取新的 locator/cursor。
