...
## 本地 OCR 与私有运行包（#95，v0.4.1）

OCR 默认关闭；生产 v0.4.1 已完成 Package/Deployment Protocol，部署者仍须显式配置 `READING_MCP_OCR_ENABLED=true`、
